...
gradcam_label=2
model_savedir=./checkpoints/2020_${brain_area}_lr${lr_init}_epochs${num_epochs}_class${num_classes}_batch4_nodrop_32_64_128_gap_mouse11_${timelen}s_focal_gamma${gamma}_${mice_flist}_alpha0.25
echo "$model_savedir"
